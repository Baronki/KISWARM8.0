#!/usr/bin/env python3
"""
KISWARM8.0 - Module 31: Security Guard (HexStrike)
==================================================
Core security guard module for KISWARM.

Ported from: KISWARM6.0 hexstrike_guard.py
Purpose: 150+ security tools integration, threat detection,
         intrusion prevention, and autonomous defense.
